...
public:
    ...
    std::vector<std::vector<double>> maximize(MatroidSetFunction &f_obj, double delta = -1, double epsilon = 0.1, bool verbose = false, bool showProgress = true, const std::vector<std::vector<double>> &costs = std::vector<std::vector<double>>());
