...
// 	}
// }
std::unordered_set<ll> SetFunction::maximize(std::string optimizer, std::unordered_set<std::unordered_set<ll>, hash_function_set> &I)
{
	if (optimizer == "AcceleratedContinuousGreedy") {
		return AcceleratedContinuousGreedyOptimizer().maximize(*this, I);
	}
	else {
